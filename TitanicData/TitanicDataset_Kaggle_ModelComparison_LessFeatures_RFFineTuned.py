...
labels_pred5 = model1.predict(X_test)
labels_pred6 = model2.predict(X_test)
labels_pred7 = model3.predict(X_test)
labels_pred8 = model4.predict(X_test)
...
predictions = (labels_pred5+labels_pred6+labels_pred7+labels_pred8)/4

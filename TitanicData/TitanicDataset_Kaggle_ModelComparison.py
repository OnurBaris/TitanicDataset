...
features_list = ["Pclass", "SibSp", "Parch", "Age", "Fare", "Sex_female", "Sex_male"]
...
feat_select=SelectKBest(f_classif, k=3).fit(X, y)
plt.bar(features_list, feat_select.scores_, width=.2, label=r'Scores', color='darkorange', edgecolor='black')
plt.show()

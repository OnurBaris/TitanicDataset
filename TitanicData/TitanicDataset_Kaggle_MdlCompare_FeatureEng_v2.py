...
features = ["Pclass", "Sex", "Title", "familysize", "Age"]
...
X_scaled[['Pclass','familysize','Age']] = scaler.fit_transform(X_scaled[['Pclass','familysize','Age']])
X_scaled_test[['Pclass','familysize','Age']] = scaler.fit_transform(X_scaled_test[['Pclass','familysize','Age']])
...
model2.fit(X, y)
model3 = MLPClassifier(solver='lbfgs', alpha=1e-5, hidden_layer_sizes=(9, 3), random_state=1, max_iter=2000)
